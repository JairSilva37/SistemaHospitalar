...
namespace Cooperchip.ITDeveloper.Mvc.Extensions.ViewComponents.NotifyEvent
{
    ...
    public class NotifyEventViewComponents: ViewComponent
    {
        ...
        public async Task<IViewComponentResult>InvokeAsync()
        {
            ...
            var notificacoes= await _context.Set<Triagem>().AsNoTracking().OrderBy(x=>x.DataNotificacao).ToListAsync();
