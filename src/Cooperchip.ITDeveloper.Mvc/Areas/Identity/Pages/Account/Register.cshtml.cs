...
namespace Cooperchip.ITDeveloper.Mvc.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [StringLength(100, ErrorMessage = "O {0} deve possuir de {2} a máximo {1} characters long.", MinimumLength = 8)]
        ...
        public async Task<IActionResult> OnPostAsync(IFormFile file, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //TODO: implementar o upload da imagem de perfil posteriormente utilizar patters Iunitofforks;
